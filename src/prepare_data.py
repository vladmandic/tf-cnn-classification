...
def load_and_preprocess_image(image_raw, data_augmentation=True):
    # decode
    ...
    if data_augmentation:
        ...
        image = tf.image.resize_with_crop_or_pad(image=image, target_height=int(IMAGE_HEIGHT * 1.2), target_width=int(IMAGE_WIDTH * 1.2))
